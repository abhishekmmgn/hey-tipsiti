			...
			<div className="flex">
				<div className="flex flex-col gap-1">
					<div className="flex flex-row gap-2 items-center">
						...
						<div className="text-sm sm:text-base text-tertiary-foreground">
							{row.airportCode}
						</div>
						<div>·</div>
						<div className="text-sm sm:text-base truncate max-w-32 sm:max-w-64 text-tertiary-foreground">
							{row.airportName}
						</div>
					</div>
...
export function FlightStatus({ flightStatus = SAMPLE }) {
	return (
		<div className="flex flex-col gap-2 bg-tertiary rounded-lg p-4">
			...
			<div className="h-px grow bg-tertiary-foreground/20" />
			...
			<div className="flex flex-row gap-2 items-center">
				...
				<div className="h-px grow bg-tertiary-foreground/20 ml-2" />
			</div>
