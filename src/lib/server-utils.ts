...
import { TipsitiItemType } from "@/lib/types";
...
export async function getId(type: TipsitiItemType, name: string): Promise<string> {
    ...
    if (ITEM_TYPE === "country") {
        ...
        try {
            ...
            const filteredCity = data.filter(city => city.name.toLowerCase() === name.toLowerCase())
